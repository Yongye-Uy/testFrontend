...
import type { Permission, PermissionsResponse } from "@/app/types/permission";
import type { Role, RolesResponse } from "@/app/types/role";
import type {
  BulkInviteResponse,
  InviteUserEntry,
  LoginResponse,
...
function normalizeLessonItem(raw: unknown): LessonItem {
  ...
  return {
    ...
    display_order: toNumber(value.display_order) ?? 0,
