...
export function StudentQuizTakePage({
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-cream-50">
      {/* Top bar */}
      <div className="flex items-center gap-4 border-b border-ink-200 bg-white px-6 py-3 shadow-sm">
        <h1 className="flex-1 truncate font-serif-display text-[1rem] font-semibold text-navy-900">
          Quiz in progress
        </h1>
        ...
        <button
          ...
          disabled={submitting}
          className="rounded-xl bg-navy-900 px-4 py-2 text-sm font-bold text-cream-50 transition hover:bg-navy-800 disabled:opacity-50"
        >
          Submit quiz
        </button>
      </div>
