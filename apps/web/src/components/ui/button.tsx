...
const variants: Record<ButtonVariant, string> = {
  primary: "bg-navy-800 text-cream-50 shadow-soft hover:bg-navy-700 active:bg-navy-900",
  secondary: "bg-cream-200 text-navy-900 hover:bg-cream-300 active:bg-cream-300",
  ...
  outline: "bg-white text-navy-800 ring-1 ring-ink-300 hover:bg-cream-100 hover:ring-ink-400",
};
